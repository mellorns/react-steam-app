                    ...
                    <div className='swiper-slide-content'>
                        ...
                        <div className='sale-game-block'>
                            ...
                            <ul className='game-images-list'>
                                ...
                                <li>
                                    <img src="images/slider_1_3.png" onClick={() => openLigthBox("images/slider_1_2.png")} alt="" />
                                </li>
                                <li>
                                    <img src="images/slider_1_4.png" onClick={() => openLigthBox("images/slider_1_2.png")} alt="" />
                                </li>
                                <li>
                                    <img src="images/slider_1_5.png" onClick={() => openLigthBox("images/slider_1_2.png")} alt="" />
                                </li>
                            </ul>
